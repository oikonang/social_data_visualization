 ...
 *
 */
(function(factory) { if (typeof define === "function" && define.amd) { define(["leaflet", "d3"], factory) } else if (typeof module === "object" && module.exports) { module.exports = factory(require("leaflet", "d3")) } else { factory(L, d3) } })(function(L, d3) {
    if (typeof d3 == "undefined") { throw "D3 SVG Overlay for Leaflet requires D3 library loaded first" }
    ...
    L.D3SvgOverlay = (L.version < "1.0" ? L.Class : L.Layer).extend({
        ...
        _options: function(options) {
            if (this._undef(options)) { return this.options }
        ...
        _enableLeafletRounding: function() { L.Point.prototype._round = this._leaflet_round },
        draw: function() {
        ...
        onRemove: function(map) {
            ...
            } else { this._svg.remove() }
        },
        addTo: function(map) { map.addLayer(this); return this }
    });
    L.D3SvgOverlay.version = "2.1";
    L.d3SvgOverlay = function(drawCallback, options) { return new L.D3SvgOverlay(drawCallback, options) }
});